...
plot.hist(jared_profit_loss, range=(-100000, 100000), bins=20, edgecolor='red');
plot.title("Profit Loss data from Jareds' sales");
plot.xlabel('Sales Amount');
plot.ylabel('Count');
plot.axvline(jared_profit_loss_mean, color='r', linestyle='solid', linewidth=2, label="Mean");
plot.axvline(jared_median_profit_loss, color='g', linestyle='dotted', linewidth=2, label='Median');
plot.legend();
